...
<body>
	<form action="twoselect.jsp" method="post">
		<div class="container">
			<%
			...
			%>
			<label class="btn btn-dark"><input type="radio" name="food2" value=<%=category%>><%=category%></label>
			<%
				}
		...
		<div class="container text-center">
			...
			<input type="button" class="btn btn-success" onclick="javascript:location.replace('main.jsp')" value="HOME" />
		</div>
		<br>
		<br>
...
<!-- 제품 정보 제공 -->
		<div class="container">
			...
			<%
				String Query = "SELECT name,information FROM pill where information like ?";
            ...
            <h4 class="title"><a href="">제품명:<%=name %></a></h4>
					<%
						out.println("<BR>");
						out.println("제품 기능:");
						out.println(info);
